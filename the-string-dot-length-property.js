...
console.log("The length of stringOne, " + stringOne + ", is: " + lengthOne +".");
console.log(
  "The length of stringTwo, " + stringTwo + ", is: " + lengthTwo + "."
);
console.log(
  "The length of stringThree, " + stringThree + ", is: " + lengthThree + "."
);
